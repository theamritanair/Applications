...
import java.util.ArrayList;
    ...
    public final class QueryUtils {
        ...
        public static ArrayList<Earthquake> extractEarthquakes() {
            ...
            try {
                JSONObject earthq = new JSONObject(SAMPLE_JSON_RESPONSE);
                JSONArray features = earthq.getJSONArray("features");
                ...
                // build up a list of com.example.android.quakereport.Earthquake objects with the corresponding data.

            } catch (JSONException e) {
                // If an error is thrown when executing any of the above statements in the "try" block,
                // catch the exception here, so the app doesn't crash. Print a log message
                // with the message from the exception.
                Log.e("yo", "Problem parsing the earthquake JSON results", e);
            }
